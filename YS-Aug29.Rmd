...
# those 1326
expected_id = (result %>% filter(modelname %in% c("ivfe", "ivre")) %>% 
  group_by(MA.id) %>% mutate(Significant_sum = sum(Significant_num)) %>% 
  filter(Significant_sum == 1, Significant == "significant", modelname == "ivfe"))$MA.id

# those 55
strange_id = (result %>% filter(modelname %in% c("ivfe", "ivre")) %>% 
  group_by(MA.id) %>% mutate(Significant_sum = sum(Significant_num)) %>% 
...
result_strange <- result %>% filter(MA.id %in% strange_id) 
prop.table(table(result_strange$event))

cor( (result %>% filter(modelname %in% c("ivfe"), MA.id %in% strange_id))$est,
     (result %>% filter(modelname %in% c("ivre"), MA.id %in% strange_id))$est )

cor( (result %>% filter(modelname %in% c("ivfe"), MA.id %in% strange_id))$se,
     (result %>% filter(modelname %in% c("ivre"), MA.id %in% strange_id))$se )
```


```{r}
result %>% filter(modelname %in% c("ivfe", "ivre")) %>% 
  filter(MA.id %in% expected_id) %>% 
  group_by(MA.id) %>% mutate(avg_est = mean(est)) %>% arrange(avg_est) %>%
  group_by(modelname) %>%
  mutate(index = row_number()) %>%
  ungroup() %>% 
...
cor( (result %>% filter(modelname %in% c("ivfe"), MA.id %in% expected_id))$est,
     (result %>% filter(modelname %in% c("ivre"), MA.id %in% expected_id))$est )

cor( (result %>% filter(modelname %in% c("ivfe"), MA.id %in% expected_id))$se,
     (result %>% filter(modelname %in% c("ivre"), MA.id %in% expected_id))$se )


result_expected <- result %>% filter(MA.id %in% expected_id) 
...
# those 4347
expected_id = (result %>% filter(modelname %in% c("ctevaguelogit", "htevaguelogit")) %>% 
  group_by(MA.id) %>% mutate(Significant_sum = sum(Significant_num)) %>% 
  filter(Significant_sum == 1, Significant == "significant", modelname == "ctevaguelogit"))$MA.id

# those 102
strange_id = (result %>% filter(modelname %in% c("ctevaguelogit", "htevaguelogit")) %>% 
  group_by(MA.id) %>% mutate(Significant_sum = sum(Significant_num)) %>% 
...
cor( (result %>% filter(modelname %in% c("ctevaguelogit"), MA.id %in% strange_id))$est,
     (result %>% filter(modelname %in% c("htevaguelogit"), MA.id %in% strange_id))$est )

cor( (result %>% filter(modelname %in% c("ctevaguelogit"), MA.id %in% strange_id))$se,
     (result %>% filter(modelname %in% c("htevaguelogit"), MA.id %in% strange_id))$se )
...
cor( (result %>% filter(modelname %in% c("ctevaguelogit"), MA.id %in% expected_id))$est,
     (result %>% filter(modelname %in% c("htevaguelogit"), MA.id %in% expected_id))$est )

cor( (result %>% filter(modelname %in% c("ctevaguelogit"), MA.id %in% expected_id))$se,
     (result %>% filter(modelname %in% c("htevaguelogit"), MA.id %in% expected_id))$se )
...
# those 6913
expected_id = (result_narm %>% filter(modelname %in% c("ctebeta", "htebeta")) %>% 
  group_by(MA.id) %>% mutate(Significant_sum = sum(Significant_num)) %>% 
  filter(Significant_sum == 1, Significant == "significant", modelname == "ctebeta"))$MA.id

# those 18
strange_id = (result_narm %>% filter(modelname %in% c("ctebeta", "htebeta")) %>% 
  group_by(MA.id) %>% mutate(Significant_sum = sum(Significant_num)) %>% 
...
cor( (result_narm %>% filter(modelname %in% c("ctebeta"), MA.id %in% strange_id))$est,
     (result_narm %>% filter(modelname %in% c("htebeta"), MA.id %in% strange_id))$est )

cor( (result_narm %>% filter(modelname %in% c("ctebeta"), MA.id %in% strange_id))$se,
     (result_narm %>% filter(modelname %in% c("htebeta"), MA.id %in% strange_id))$se )


result_strange <- result_narm %>% filter(MA.id %in% strange_id) 
prop.table(table(result_strange$event))
```
...
weird.id = (result_narm %>% filter(modelname %in% c("ctebeta", "htebeta")) %>% 
    filter(MA.id %in% expected_id) %>% group_by(MA.id) %>% summarize(diff(width)) %>% filter(`diff(width)` < 0))$MA.id
...
cor( (result_narm %>% filter(modelname %in% c("ctebeta"), MA.id %in% expected_id))$est,
     (result_narm %>% filter(modelname %in% c("htebeta"), MA.id %in% expected_id))$est )

cor( (result_narm %>% filter(modelname %in% c("ctebeta"), MA.id %in% expected_id))$se,
     (result_narm %>% filter(modelname %in% c("htebeta"), MA.id %in% expected_id))$se )


result_expected <- result_narm %>% filter(MA.id %in% expected_id) 
prop.table(table(result_expected$event))
```
...
# 
expected_id = (result_narm %>% filter(modelname %in% c("ivfe", "ctevaguelogit")) %>% 
  group_by(MA.id) %>% mutate(Significant_sum = sum(Significant_num)) %>% 
  filter(Significant_sum == 1, Significant == "significant", modelname == "ivfe"))$MA.id

#
strange_id = (result_narm %>% filter(modelname %in% c("ivfe", "ctevaguelogit")) %>% 
  group_by(MA.id) %>% mutate(Significant_sum = sum(Significant_num)) %>% 
  filter(Significant_sum == 1, Significant == "significant", modelname == "ctevaguelogit"))$MA.id
```
...
cor( (result %>% filter(modelname %in% c("ivfe"), MA.id %in% strange_id))$est,
     (result %>% filter(modelname %in% c("ctevaguelogit"), MA.id %in% strange_id))$est )

cor( (result %>% filter(modelname %in% c("ivfe"), MA.id %in% strange_id))$se,
     (result %>% filter(modelname %in% c("ctevaguelogit"), MA.id %in% strange_id))$se )
...
result %>% filter(modelname %in% c("ivfe", "ctevaguelogit")) %>% 
    filter(MA.id %in% expected_id) %>% group_by(MA.id) %>% summarize(diff(width)) %>% filter(`diff(width)` < 0)
result %>% filter(modelname %in% c("ivfe", "ctevaguelogit")) %>% 
    filter(MA.id %in% strange_id) %>% group_by(MA.id) %>% summarize(diff(width)) %>% filter(`diff(width)` < 0)
...
cor( (result %>% filter(modelname %in% c("ivfe"), MA.id %in% expected_id))$est,
     (result %>% filter(modelname %in% c("ctevaguelogit"), MA.id %in% expected_id))$est )

cor( (result %>% filter(modelname %in% c("ivfe"), MA.id %in% expected_id))$se,
     (result %>% filter(modelname %in% c("ctevaguelogit"), MA.id %in% expected_id))$se )
...
# 
expected_id = (result %>% filter(modelname %in% c("ivre", "htevaguelogit")) %>% 
  group_by(MA.id) %>% mutate(Significant_sum = sum(Significant_num)) %>% 
  filter(Significant_sum == 1, Significant == "significant", modelname == "ivre"))$MA.id

#
strange_id = (result %>% filter(modelname %in% c("ivre", "htevaguelogit")) %>% 
  group_by(MA.id) %>% mutate(Significant_sum = sum(Significant_num)) %>% 
  filter(Significant_sum == 1, Significant == "significant", modelname == "htevaguelogit"))$MA.id
```
...
cor( (result %>% filter(modelname %in% c("ivre"), MA.id %in% strange_id))$est,
     (result %>% filter(modelname %in% c("htevaguelogit"), MA.id %in% strange_id))$est )

cor( (result %>% filter(modelname %in% c("ivre"), MA.id %in% strange_id))$se,
     (result %>% filter(modelname %in% c("htevaguelogit"), MA.id %in% strange_id))$se )
...
cor( (result %>% filter(modelname %in% c("ivre"), MA.id %in% expected_id))$est,
     (result %>% filter(modelname %in% c("htevaguelogit"), MA.id %in% expected_id))$est )

cor( (result %>% filter(modelname %in% c("ivre"), MA.id %in% expected_id))$se,
     (result %>% filter(modelname %in% c("htevaguelogit"), MA.id %in% expected_id))$se )
...
# correlation of tau by different model 
